...
VisualQC's Freesufer module can be used to visualize the full cortical parcellation against the original MRI.  Here, we show the use case for a single label (subcortical segmentation, tissue class or cortical ROI) - shown here is hippocampus:
